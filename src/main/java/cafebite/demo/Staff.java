...
public class Staff {
     ...
     */
    public static boolean saveStaff(String firstName, String lastName, String staffId, String password, String staffType) {
    ...
    /**
     * Adds a new staff member to the Excel file. This method creates a new row at the end of the sheet
     ...
     */
    public static boolean addNewStaff(String firstName, String lastName, String staffId, String password, String staffType) {
        try (FileInputStream file = new FileInputStream(EXCEL_FILE);
             XSSFWorkbook workbook = new XSSFWorkbook(file)) {
        ...
        try (FileInputStream file = new FileInputStream(EXCEL_FILE);
            ...
            for (Row row : sheet) {
                ...
                if (idCell != null && idCell.getStringCellValue().equals(staffId)) {
                    ...
                    return firstNameCell.getStringCellValue() + " " + lastNameCell.getStringCellValue();
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
