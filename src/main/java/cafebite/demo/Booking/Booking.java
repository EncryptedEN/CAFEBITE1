...
public class Booking {
     ...
     */
    public Booking(String numOfGuests, String date, String hour, String minute, String duration, String table, String status) {
    ...
    public String toString() {
        return numOfGuests + ",  " + date + ",  " + hour + ",  " + minute + ",  " + duration + ",  " + table + ",  " + status + "\n";
    }
}
